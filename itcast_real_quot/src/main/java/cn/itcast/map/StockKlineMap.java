...
public class StockKlineMap extends RichMapFunction<StockBean, Row> {
    ...
    public StockKlineMap(String kType, String firstTxDateType) {
        this.kType=kType;
    ...
    public Row map(StockBean stockBean) throws Exception {
        ...
        if (firstTradeDateTime < tradeDateTime && (kType.equals(2)) || kType.equals(2)){
            ...
            Map<String, Object> map = klineMap.get(stockBean.getSecCode());
        ...
        row.setField(2,stockBean.getSecCode());
        row.setField(3,stockBean.getSecName());
